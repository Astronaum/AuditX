...
if(!isset($_SESSION["id_user"]))
    ...
    $id_affec=$_GET['id'];
    $sql1="SELECT * FROM affectations WHERE id_affectation='$id_affec'";
    $result1=mysqli_query($link,$sql1);
    $row1=mysqli_fetch_assoc($result1);
    $id_agence=$row1['id_agence'];

    $sql2="SELECT * FROM collaborateurs WHERE id_agence='$id_agence'";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php 
                    ...
                    echo '
                        <table class="table table-striped m-3 p-3 table-warning">
                        <tr>
                            <th scope="col" class="text-muted">Nom collaborateur</th>
                            <th scope="col" class="text-muted">Prénom collaborateur</th>
                    ...
                    echo '
                        <tr>
                        <td>'.$row2["nom_collaborateur"].'</td>
                        <td>'.$row2["prenom_collaborateur"].'</td>
                        <td><a class="text-decoration-none text-danger fw-bold" href=../../src/audit/detailsréponses.php?id_collab='.$row2["id_collaborateur"].'&id_role='.$row2["id_role"].'>Détails des réponses</a></td>
                        <td><a class="text-decoration-none text-success fw-bold" href=../../src/audit/recuplettre.php?id_collab='.$row2["id_collaborateur"].'&id_affec='.$id_affec.'>Récupérer lettre de recommendation</a></td>
                        </tr>
                    ';
