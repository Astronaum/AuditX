        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form class="row g-3 m-5 p-5 pt-0" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">
                        <label class="form-label">L'agence</label>
                    ...
                    <div class="col-md-12">
                        <label class="text-center text-danger fw-light"> Vérifier que tous les collaborateurs sont auditer. <a href=statut.php class="text-danger fw-bold text-decoration-none"> ICI </a></label>
                    </div>
                    <div class="col-md-12">
                        <label class="form-label">Le rapport à déposer</label>
                        <input type="file" class="form-control weirdfocus"  name="contrat" id="contrat">
                    </div>
                    <div class="col-12 mt-5 text-center">
                        <button type="submit" class="btn btn-success" name="deposer">Déposer</button>
                    </div>
                </form>
            </div>
        </div>        
...
if(isset($_POST['deposer'])){
    ...
    $agence=$_POST['agence'];
                            if(isset($_FILES['contrat'])){
                                ...
                                $file_name=$id_audit_cour."rapoort".$agence.".".$file_ext;
                                if(empty($errors)==true){
                                   move_uploaded_file($file_tmp,"../../rapports/".$file_name);
                                }else{
                                   print_r($errors);
                                }
                             }
 
    $sql3="UPDATE affectations set rapport='$file_name' where id_audit='$id_audit_cour' and id_agence='$agence' ";
