...
<head>
    ...
    <title>AuditX - Ajout auditeur</title>
            ...
            <div id="content">
                ...
                <form class="row g-3 m-5 p-5 pt-0" method="post">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control weirdfocus" name="nom_auditeur" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Prénom</label>
                        <input type="text" class="form-control weirdfocus" name="prenom_auditeur" required>
                    </div>
                    <div class="col-6">
                        <label class="form-label">Bureau</label>
                        <input type="text" class="form-control weirdfocus" name="bureau" required>
                    </div>
                    <div class="col-6">
                        <label class="form-label">Téléphone</label>
                        <input type="text" class="form-control weirdfocus" name="telephone" required>
                    </div>
...
<?php
if(isset($_POST['enregistrer']) && !empty($_POST['nom_auditeur'])){
    ...
    $sql4="INSERT into users values(NULL,'1','$username','azerty')";
    $resultat4=mysqli_query($link,$sql4);

    $sql3="INSERT into audits values(NULL,'$nom','$prenom','$bureau','$telephone')";
