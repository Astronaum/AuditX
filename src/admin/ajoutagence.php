...
<head>
    ...
    <title>AuditX - Ajout agence</title>
            ...
            <div id="content">
                ...
                <form class="row g-3 m-5 p-5 pt-0" method="post">
                    <div class="col-md-6">
                        ...
                        <select class="form-select weirdfocus" id="ville" name="ville">
                        <?php
										$sql1="SELECT * from ville";
										$result1=mysqli_query($link,$sql1);
										while ($ville=mysqli_fetch_assoc($result1))
										{
										echo '<option value='.$ville["libelle_ville"].'>';
										echo $ville["libelle_ville"];
										echo'</option>';
										}
										?>
                                </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <?php
										$sql2="SELECT * from societes";
										$result2=mysqli_query($link,$sql2);
										while ($societe=mysqli_fetch_assoc($result2))
										{
										echo '<option value='.$societe["id_societe"].'>';
										echo $societe["libelle_societe"];
										echo'</option>';
										}
										?>
                                </select>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control weirdfocus" name="nom_agence" required>
                    </div>
...
<?php
if(isset($_POST['enregistrer']) && !empty($_POST['nom_agence'])){
    $nom=$_POST['nom_agence'];
    $societe=$_POST['societe'];
    $ville=strtoupper($_POST['ville']);
    $sql3="INSERT into agences values(NULL,'$societe','$ville','$nom')";
