        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="d-flex justify-content-center mt-5">
                    <div class="card ms-2 shadow rounded-0" style="width: 18rem;">
                            <div class="card-header text-center">Nombre de collaborateurs</div>
                            <div class="card-body">
                            <?php 
                            $sql1="SELECT * from collaborateurs";
                    ...
                    <div class="card ms-2 shadow rounded-0" style="width: 18rem;">
                            <div class="card-header text-center">Nombre d'agences</div>
                            <div class="card-body">
                            <?php 
                            $sql1="SELECT * from agences";
                            $result1=mysqli_query($link,$sql1);
                            if ($result1)
                            {
                                $row = mysqli_num_rows($result1);
                    ...
                    <div class="card ms-2 shadow rounded-0" style="width: 18rem;">
                            <div class="card-header text-center text-danger">Nombre d'audits courants</div>
                            <div class="card-body">
                            <?php 
                            $sql1="SELECT * from affectations where rapport IS NULL";
                            $result1=mysqli_query($link,$sql1);
                            if ($result1)
                            {
                                $row = mysqli_num_rows($result1);
                            }
                                echo"<h1 class=\"text-center text-danger\">$row</h1>";
                            ?>                            </div>
                    </div>
                </div>
            </div>
