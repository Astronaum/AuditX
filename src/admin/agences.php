        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="col-md-10 justify-content-center m-auto">
                    ...
                    <input type="text" class="form-control weirdfocus mb-5" name="search_text" id="search_text" placeholder="Chercher par nom...">
                </div>
