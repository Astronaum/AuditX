...
if(isset($_POST["query"]))
{
 ...
 $query = "
  ...
  WHERE nom_collaborateur LIKE '%".$search."%'
  OR prenom_collaborateur LIKE '%".$search."%'
...
if(mysqli_num_rows($result) > 0)
{
 $output .= '
    ...
    <tr><th scope="col" class="text-muted">Nom</th><th scope="col" class="text-muted">Prénom</th><th scope="col" class="text-muted">Matricule</th><th scope="col"></th><th scope="col"></th>
    <tbody>
    </tr>
 ';
 while($row = mysqli_fetch_array($result))
 {
  $output .= '
   <tr>
    ...
    <td>'.$row["matricule"].'</td>
    <td><a class="text-decoration-none text-dark fw-bold " href=detailscollaborateur.php?id_collaborateur='.$row["id_collaborateur"].' >Détails</a></td>
    <td><a class="text-decoration-none text-danger fw-bold" href=supprimercollaborateur.php?id_collaborateur='.$row["id_collaborateur"].' >Supprimer</a></td>
    </tr>
  ';
 }
 echo $output;
